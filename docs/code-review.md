...
- The module currently uses custom translation arrays in PHP. Moving to `.po` files would make translation maintenance more consistent with newer hh modules.
